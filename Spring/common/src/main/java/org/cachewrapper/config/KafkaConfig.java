...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Event> producerFactory() {
        ...
        JacksonJsonSerializer<Event> jsonSerializer = new JacksonJsonSerializer<>();
    ...
    public ConsumerFactory<String, Event> consumerFactory() {
        JacksonJsonDeserializer<Event> jsonDeserializer = new JacksonJsonDeserializer<>(Event.class);
